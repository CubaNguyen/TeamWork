...
const EditAddress = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        let address = formData.address + ", thành phố " + formData.city + ', ' + formData.country
        let userId = user.id
        try{
    ...
    return (
        <div className='editAddressContainer'>
            <NavLink style={{ color: 'white' }} to="/account" className="back-link">Quay lại chi tiết tài khoản</NavLink>
            <h2 className="title">Địa chỉ của bạn : {user.address ? user.address : "Hong có"}</h2>
            <div className="address-card">
                ...
                <div className="actions">
                    {!edit &&
                        <>
                            <a className="edit" onClick={() => setEdit(true)}>Sửa</a>
                ...
                <>
                    <div className="form-container">
                        <form className="address-form" onSubmit={handleSubmit}>
                            ...
                            <button type="submit" className="submit-btn" >Thêm địa chỉ</button>
                            <button type="button" className="cancel-btn" onClick={() => setEdit(false)}>Hủy</button>
                        </form>
                    </div>
                </>
            }
