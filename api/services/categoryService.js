...
const getAllCategoriesService = async () => {
    try {
        ...
        return { message: "Lấy danh sách đơn hàng thành công!", code: 201, data: categories };
    }
    catch (err) {
...
const addCategoryService = async (name, description) => {
    try {
        ...
        return { message: "Thêm sản phẩm thành công!", code: 201, data: newCategory };
    }
    catch (err) {
...
module.exports = {
    getAllCategoriesService, addCategoryService, deleteCategoryService
